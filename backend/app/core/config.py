...
class Settings(BaseSettings):
    ...
    file_request_max_bytes: int = Field(
        default=26_214_400, ge=1_048_576, le=104_857_600
    )
    ...
    analytics_internal_url: str = "http://analytics:4100"
    analytics_timeout_ms: int = Field(default=800, ge=50, le=10_000)
    ...
    @property
    def analytics_env_label(self) -> str:
